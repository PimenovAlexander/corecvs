...
#ifndef MYBLASREPLACEMET_H
#define MYBLASREPLACEMET_H
...
//    // in order to accelerate the matrix-matrix product, matrix blocks are copied into local buffers.

    

//    SseMicroKernelMM(const Matrix *pA, const Matrix *pB, Matrix *pResult) : pA(pA), pB(pB), pResult(pResult)
//    {
//    }
//    const Matrix *pA;
//    const Matrix *pB;
