...
find_path(JPEG_INCLUDE_DIR jpeglib.h PATHS ${JPEG_INCLUDE_SEARCH_PATHS})
...
if(NOT JPEG_LIBRARY)
  find_library(JPEG_LIBRARY_RELEASE NAMES ${jpeg_names} PATHS ${JPEG_LIB_SEARCH_PATHS})
  find_library(JPEG_LIBRARY_DEBUG NAMES ${jpeg_names_debug} PATHS ${JPEG_LIB_SEARCH_PATHS})
