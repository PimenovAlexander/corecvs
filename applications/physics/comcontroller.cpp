...
using namespace std;
    ...
    ComController::ComController(int &_yaw_value, int &_roll_value, int &_pitch_value, int &_throttle_value, int &_CH5_value, int &_CH6_value, int &_CH7_value,  int &_CH8_value )
    ...
    void ComController::BindToRealDrone()
    {
    ...
    void ComController::SendOurValues(std::vector<uint8_t> OurValues)
    {
